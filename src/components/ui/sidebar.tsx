  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "has-data-[variant=inset]:bg-[#000B4E] flex min-h-svh w-full rounded-r-lg",
          className
        )}
        {...props}
      >
...
function Sidebar({
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-[#000B4E] text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
  ...
  return (
    <div
      className="group peer text-sidebar-foreground hidden md:flex h-svh"
      data-state={state}
      data-collapsible={state === "collapsed" ? collapsible : ""}
      data-variant={variant}
      data-side={side}
      data-slot="sidebar"
      style={{ minWidth: `var(--sidebar-width)`, width: `var(--sidebar-width)`, transition: 'width 0.2s' }}
    >
      <div
        data-sidebar="sidebar"
        data-slot="sidebar-inner"
        className="bg-[#000B4E] flex size-full flex-col"
      >
        {children}
      </div>
    </div>
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "no-scrollbar gap-0 flex min-h-0 flex-1 flex-col group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
